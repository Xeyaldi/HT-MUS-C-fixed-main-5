...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/musiicays")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/+9qnS9NvUzucyYTBi")

# Get your key from https://www.pexels.com/api/ (used by /img and /vid)
PEXELS_API_KEY = getenv("PEXELS_API_KEY", None)
# Path to the JSON catalog used by /catalog and /addfile
CATALOG_PATH = getenv("CATALOG_PATH", "./SHUKLAMUSIC/utils/data/catalog.json")
